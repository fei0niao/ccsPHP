...
use App\Http\Model\PlatformFlow;

class PlatformFlowController extends Controller
{
    use \App\Http\Controllers\Load\ShowBaseTrait;

    public static $model_name = 'PlatformFlow';
    ...
    public function update($id, Request $request)
    {
        ...
        $rs = PlatformFlow::find($id)->fill($fills)->save();
