...
use App\Http\Model\TodayEntrust;

class TodayEntrustController extends Controller
{
    use \App\Http\Controllers\Load\ShowBaseTrait;

    public static $model_name = 'TodayEntrust';
    ...
    public function update($id, Request $request)
    {
        ...
        $rs = TodayEntrust::find($id)->fill($fills)->save();
