...
use App\Http\Model\HistoryParentEntrust;

class HistoryParentEntrustController extends Controller
{
    use \App\Http\Controllers\Load\ShowBaseTrait;

    public static $model_name = 'HistoryParentEntrust';
    ...
    public function create(Request $request)
    {
        ...
        $rs = HistoryParentEntrust::create($fills);
    ...
    public function update($id, Request $request)
    {
        ...
        $rs = HistoryParentEntrust::find($id)->fill($fills)->save();
