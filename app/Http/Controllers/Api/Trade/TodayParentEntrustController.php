...
use App\Http\Model\TodayParentEntrust;

class TodayParentEntrustController extends Controller
{
    use \App\Http\Controllers\Load\ShowBaseTrait;

    public static $model_name = 'TodayParentEntrust';
    ...
    public function create(Request $request)
    {
        ...
        $rs = TodayParentEntrust::create($fills);
    ...
    public function update($id, Request $request)
    {
        ...
        $rs = TodayParentEntrust::find($id)->fill($fills)->save();
