...
use App\Http\Model\HistoryDeal;

class HistoryDealController extends Controller
{
    use \App\Http\Controllers\Load\ShowBaseTrait;

    public static $model_name = 'HistoryDeal';
    ...
    public function update($id, Request $request)
    {
        ...
        $rs = HistoryDeal::find($id)->fill($fills)->save();
