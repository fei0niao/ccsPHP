...
class TodayDeal extends Base
{
    ...
    {
        return $this->belongsTo(TodayEntrust::Class, 'stock_finance_entrust_id', 'id');
    }
    ...
    {
        return $this->belongsTo(TodayParentEntrust::Class, 'parent_entrust_id', 'id');
    }
    ...
    {
        return $this->belongsTo(TodayParentDeal::Class, 'parent_makedeal_id', 'id');
    }
