...
class HistoryEntrust extends Base
{
    protected $table = "u_stock_finance_entrust_history";
    ...
    {
        return $this->hasOne(HistoryParentEntrust::Class, 'stock_finance_entrust_id', 'id');
    }

    /**
     * hasMany成交
     */
    public function historyDeal()
    {
        return $this->hasMany(HistoryDeal::Class, 'stock_finance_entrust_id', 'id');
    }
    ...
    {
        return $this->hasMany(HistoryParentDeal::Class, 'stock_finance_entrust_id', 'id');
    }
